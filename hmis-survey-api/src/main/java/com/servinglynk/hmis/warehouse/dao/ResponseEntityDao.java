...
List<ResponseEntity> getAllSurveyResponsesForClient(UUID surveyId, UUID clientDedupId, Integer startIndex, Integer maxItems);
long getSurveyResponsesForClientCount(UUID surveyid,UUID clientDedupId);
